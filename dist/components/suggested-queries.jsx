...
exports.SuggestedQueries = void 0;
const framer_motion_1 = require("framer-motion");
const button_1 = require("./ui/button");
const SuggestedQueries = ({ handleSuggestionClick, }) => {
    ...
    return (<framer_motion_1.motion.div key="suggestions" initial={{ opacity: 0 }} animate={{ opacity: 1 }} layout exit={{ opacity: 0 }} className="h-full overflow-y-auto">
      <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-4">
        Try these queries:
      </h2>
      <div className="flex flex-wrap gap-2">
        {suggestionQueries.map((suggestion, index) => (<button_1.Button key={index} className={index > 5 ? "hidden sm:inline-block" : ""} type="button" variant="outline" onClick={() => handleSuggestionClick(suggestion.desktop)}>
...
exports.SuggestedQueries = SuggestedQueries;
